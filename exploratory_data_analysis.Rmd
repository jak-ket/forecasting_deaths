...
forecast_deaths <- function(cases, deaths, lag, horizon, window=7){
...
ag_nr <- 5
ag <- ags[ag_nr]
fc <- forecast_deaths(cases_wide[,ag], deaths_wide[,ag], lag=max_cor_lags[ag_nr], horizon=10, window=7)
```
