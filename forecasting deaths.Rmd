...
end <- as.Date("2021-01-31") #NA # give exact date or NA to choose end of time series
...
# TODO: remove dates_excluded from training_period and filter data accordingly
